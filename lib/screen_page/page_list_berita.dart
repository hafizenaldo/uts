...
import 'package:uts/screen_page/page_detail_berita.dart';
import 'package:uts/screen_page/page_login.dart';
import 'package:uts/utils/session_manager.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://172.20.10.6/uts_mobile//berita.php"),
      );

      return modelBeritaApiFromJson(response.body).data;
    } catch (e) {
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://172.20.10.6/uts_mobile/image/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
